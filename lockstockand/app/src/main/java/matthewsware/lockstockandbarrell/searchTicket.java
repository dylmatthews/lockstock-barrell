            ...
            if (mUser != null) {
                ...
                imgRef.getFile(localFile)
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(searchTicket.this, "Download User Profile Pic failed", Toast.LENGTH_SHORT).show();
                        // ...
                    }
                });
            }
        ...
        if (!ticketNum.isEmpty())
        {
            mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    try {
                        Intent intent = new Intent(searchTicket.this, scrollViewRepair.class);
                    ...
                    {
                        e.printStackTrace();
                        Toast.makeText(searchTicket.this, "There was an error switching screens", Toast.LENGTH_SHORT).show();
                    }
                }
            });

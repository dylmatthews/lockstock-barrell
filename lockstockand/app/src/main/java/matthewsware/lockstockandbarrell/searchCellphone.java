...
public class searchCellphone extends AppCompatActivity
            ...
            if (mUser != null) {
                ...
                imgRef.getFile(localFile)
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(searchCellphone.this, "Download User Profile Pic failed", Toast.LENGTH_SHORT).show();
                        // ...
                    }
                });
            }
    ...
    public void onSearchCellphone(View view)
    {
        ...
        if (!cellphone.isEmpty())
        {
            mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    try {
                        Intent intent = new Intent(searchCellphone.this, scrollViewRepair.class);
                    ...
                    {
                        e.printStackTrace();
                        Toast.makeText(searchCellphone.this, "There was an error switching screens", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        {
            Toast.makeText(this, "You left the field empty", Toast.LENGTH_SHORT).show();
        }
    }
